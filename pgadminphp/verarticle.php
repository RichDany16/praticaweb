...
<body class="sb-nav-fixed">
 ...
 <li class="breadcrumb-item active">articulo / <?php echo $id; ?></li>
      ...
      <div class="col-5 border p-5 m-auto my-5">
        ...
        <form id="form" class="d-block" method="POST" action="./articulos.php">

          <!-- Name address input-->
          <div class="form-floating mb-3">
            <input disabled name="title" value="<?php echo $article["title"] ?>" class="form-control" id="title" type="text" placeholder="nombre" required />
          ...
          <div class="form-floating mb-3">
            <input disabled name="author" value="<?php echo $article["author"] ?>" class="form-control" id="author" type="text" placeholder="Autor" required />
          ...
          <div class="form-floating mb-3">
            <textarea style="height: 150px;" disabled name="content" class="form-control" id="content" type="text" placeholder="Contenido" required><?php echo $article["content"] ?>  
          </textarea>
          ...
          <div class="form-floating mb-3">
            <input disabled value="<?php echo $article["photo"];  ?>" type="url" class="form-control" placeholder="https://" name="photo">
          ...
          <div class="form-floating mb-3">
            <input disabled name="keywords" value="<?php echo $article["keywords"] ?>" class="form-control" id="keywords" type="text" placeholder="Palabras clave" required />
