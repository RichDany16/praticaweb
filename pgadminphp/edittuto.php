...
<body class="sb-nav-fixed">
 ...
 <li class="breadcrumb-item active">articulo / <?php echo $id; ?></li>
      ...
      <div class="col-5 border p-5 m-auto my-5">
        ...
        <h2 class="text-center mb-5">Edición de Tutorial</h2>

        <form id="form" class="d-block" method="POST" action="./php/updatetuto.php">

          <!-- Name address input-->
          <div class="form-floating mb-3">
            <input name="title" value="<?php echo $tuto1["title"] ?>" class="form-control" id="title" type="text" placeholder="nombre" required />
          ...
          <div class="form-floating mb-3">
            <input name="author" value="<?php echo $tuto1["author"] ?>" class="form-control" id="author" type="text" placeholder="Autor" required />
          ...
          <div class="form-floating mb-3">
            <input name="keywords" value="<?php echo $tuto1["keywords"] ?>" class="form-control" id="keywords" type="text" placeholder="Palabras clave" required />
