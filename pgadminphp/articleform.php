...
<body class="sb-nav-fixed">
  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <h1 class="mt-4">Insertar Nuevo Articulo</h1>
      <ol class="breadcrumb">
 ...
 <li class="breadcrumb-item active">registro</li>
      ...
      <div class="col-5 border p-5 m-auto my-5">
        ...
        <h2 class="text-center mb-5">Insertar Articulo</h2>

        <form id="form" class="d-block user" method="POST" action="./php/insertarticulo.php">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            <input class="form-control form-control-user" name="keywords" class="form-control" id="keywords" type="text" placeholder="Palabra clave" required />
            <span class="help-block text-danger" id="title-span"></span>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="d-flex justify-content-center">
              <button class="btn btn-primary btn-user btn-block" id="submit" type="submit">Insertar</button>
            </div>
        </form>
      </div>
    </div>
