...
<body class="sb-nav-fixed">
 ...
 <li class="breadcrumb-item active">usuarios / <?php echo $id; ?></li>
      ...
      <div class="col-5 border p-5 m-auto my-5">
        ...
        <form id="form" class="d-block" method="POST" action="./users.php">

          <!-- Name address input-->
          <div class="form-floating mb-3">
            <input disabled name="name" value="<?php echo $user2["name"] ?>" class="form-control" id="name" type="text" placeholder="nombre" required />
          ...
          <!-- Email address input-->
          <div class="form-floating mb-3">
            <input  disabled name="email" value="<?php echo $user2["email"] ?>" class="form-control" id="email" type="email" placeholder="nombre@correo.com" required />
          ...
          <!-- password input-->
          <div class="form-floating mb-3">
            <input disabled name="password" value="<?php echo $user2["password"] ?>" class="form-control" required id="password" placeholder="Contraseña" data-sb-validations="required" />
          ...
          <!-- password input-->
          <div class="form-floating mb-3">
            <input disabled name="repassword" class="form-control" required id="repassword" value="<?php echo $user2["password"] ?>" placeholder="Confirmar contraseña" data-sb-validations="required" />
          ...
          <!-- password input-->
          <div class="form-floating mb-3">
            <input disabled value="<?php echo $user2["photo"];  ?>" type="url" class="form-control" placeholder="https://" name="photo">
