  ...
  <body>
    ...
    <div class="container px-3 py-3" id="featured-3">
      ...
      <a href="unidades3.php"
        ><button type="button" class="btn btn-dark me-2">Unidad 3</button></a
      >
    ...
    <div class="container px-6 py-6" id="featured-3">
      <h2 class="pb-2 border-bottom">
        3. Configuracion y administracion del espacio en el disco.
      </h2>
      <div class="container marketing">
        <div class="row featurette">
          <div class="col-md-6">
            ...
            <p class="lead">
              <li>
                Comprende las actividades de la administración de  en disco y 
              ...
              para que el funcionamiento del SGBD sea congruente
          ...
          <div class="col-md-6">
            <br />
            <img src="img/unidad3.png" alt="" width="100%" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container px-4 py-5" id="custom-cards">
      ...
      <span class="icon2"
        ...
        ><a href="pdf/ADMINISTRACION_DEL_SISTEMA_DE_ARCHIVOS.pdf">
        Administracion del sistema</a
        >
      <div class="container px-4 py-5" id="custom-cards">
      ...
      <div class="contenedor-cartas">
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad3/Configuración y administración del espacio en disco.pdf "
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Configuración y administración del espacio en disco</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad3/Configuración y administración del espacio en disco.pdf"
        ...
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad3/Modelo entidad-relacion.pdf"
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Modelo entidad-relacion</h5>
            <br />
            <p class="card-text"></p>
            <a href="./pdf/unidad3/Modelo entidad-relacion.pdf"
              ><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a
            >
        ...
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad3/Gestion de la administracion de bases de datos.pdf"
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Gestion de la administracion de bases de datos</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad3/Gestion de la administracion de bases de datos.pdf"
              ><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a
            >
