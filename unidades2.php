  ...
  <body>
    ...
    <div class="container px-3 py-3" id="featured-3">
      ...
      <a href="unidades2.php"
        ><button type="button" class="btn btn-dark me-2">Unidad 2</button></a
      >
      ...
      <div class="container marketing">
        <div class="row featurette">
          <div class="col-md-6">
            ...
            <p class="lead">
              <li>
                Comprende los componentes de la Arquitectura del Manejador de Base de Datos con el fin de identificar las funciones de cada uno. 
              </li>
              <br />

              <li>
                Instala y configura un SGBD cumpliendo con los requisitos recomendados para su funcionamiento.
              </li>
            </p>
          </div>
          ...
          <div class="col-md-6">
            <br />
            <img src="img/unidad2.jpg" alt="" width="100%" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container px-4 py-5" id="custom-cards">
      ...
      <span class="icon2"
        ...
        ><a href="pdf/2. Arquitectura e instalación del SGBD.pdf">
            Arquitectura e instalación del SGBD</a
        >
      <div class="container px-4 py-5" id="custom-cards">
      ...
      <div class="contenedor-cartas">
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad2/Instalacion de SGBD.pdf"
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Instalacion de SGBD</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad2/Instalacion de SGBD.pdf"
        ...
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad2/Conceptos de Administración Estratégica.pdf"
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Conceptos de Administración Estratégica</h5>
            <br />
            <p class="card-text"></p>
            <a href="./pdf/unidad2/Conceptos de Administración Estratégica.pdf"
              ><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a
            >
        ...
        <div class="card carta" style="width: 18rem">
          <iframe
            ...
            width="560"
            height="315"
            src="pdf/unidad2/Administracion de bases de datos.pdf"
            type="aplicacion/pdf"
          ></iframe>
          <div class="card-body">
            <h5 class="card-title">Administracion de bases de datos</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad2/Administracion de bases de datos.pdf"
              ><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a
            >
