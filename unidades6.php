...
<body>
  ...
  <div class="container">
    ...
    <div class="container px-3 py-3" id="featured-3">
      ...
      <a href="unidades.php"><button type="button" class="btn btn-primary me-2">Unidad 1</button></a>
      <a href="unidades2.php"><button type="button" class="btn btn-primary me-2">Unidad 2</button></a>
      <a href="unidades3.php"><button type="button" class="btn btn-primary me-2">Unidad 3</button></a>
      <a href="unidades4.php"><button type="button" class="btn btn-primary me-2">Unidad 4</button></a>
      <a href="unidades5.php"><button type="button" class="btn btn-primary me-2">Unidad 5</button></a>
      <a href="unidades6.php"><button type="button" class="btn btn-dark me-2">Unidad 6</button></a>
    </div>
    ...
    <div class="container px-4 py-5" id="custom-cards">
      ...
      <span class="icon2"><i class="fa fa-file-pdf-o" aria-hidden="true"></span></i><a href="pdf/1 Perspectiva de la administración de base de datos.pdf">
      ...
      <div class="container px-4 py-5" id="custom-cards">
        ...
        <li>
          <a href="https://dev.mysql.com/downloads/workbench/">Descargar workbench</a>
        </li>
        <li>
          <a href="https://www.microsoft.com/es-mx/sql-server/sql-server-downloads">Sitio oficial SQL Server</a>
        </li>
      </div>
    </div>
    ...
    <div class="container px-4" id="custom-cards">
      ...
      <div class="contenedor-cartas">
        <div class="card carta" style="width: 18rem">
          <iframe class="video-frame" width="560" height="315" src="pdf/unidad1/bases_de_datos.pdf" type="aplicacion/pdf"></iframe>
          <div class="card-body">
            <h5 class="card-title">Software libre Bases de datos</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad1/bases_de_datos.pdf"><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a>
          </div>
        </div>
        ...
        <div class="card carta" style="width: 18rem">
          <iframe class="video-frame" width="560" height="315" src="pdf/unidad1/bdatos.pdf" type="aplicacion/pdf"></iframe>
          <div class="card-body">
            <h5 class="card-title">Bases de datos</h5>
            <br />
            <p class="card-text"></p>
            <a href="./pdf/unidad1/bbatos.pdf"><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a>
          </div>
        </div>
        ...
        <div class="card carta" style="width: 18rem">
          <iframe class="video-frame" width="560" height="315" src="pdf/unidad1/Fundamentos de Bases de Datos.pdf" type="aplicacion/pdf"></iframe>
          <div class="card-body">
            <h5 class="card-title">Fundamentos de Bases de Datos</h5>
            <p class="card-text"></p>
            <a href="./pdf/unidad1/Fundamentos de Bases de Datos.pdf"><button type="button" class="btn btn-primary">
                Ver Libro
              </button></a>
          </div>
        </div>
